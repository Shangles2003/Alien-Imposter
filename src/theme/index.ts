...
export const phaseLabels: Record<string, { title: string; subtitle: string }> = {
  ...
  chamber_boarding: { title: 'Boarding', subtitle: 'Entering in a few seconds' },
  chamber_active: { title: 'Live Task', subtitle: 'All crew responding' },
  chamber_results: { title: 'Answers', subtitle: 'What everyone said' },
  identity_nominate: { title: 'Identity Check', subtitle: 'Nominate scan target' },
  identity_coop: { title: 'Repair Bay', subtitle: 'Emergency protocol' },
  identity_scan: { title: 'Scan', subtitle: 'Captain only' },
  identity_debrief: { title: 'Debrief', subtitle: 'Scan outcome' },
